...
public class  OneHundredFiftyMovingAverage extends MyDatabase{ 
	/**
	 * 
	 * 
	 * 
	...
	public void addDataX() throws Exception {
		...
		String mysql = "SELECT * FROM fortune.data where date=curdate() and onehundredfiftychg between 0.005  and  0.05 ";
		String mysql1 ="INSERT INTO techstr (code,date ,mode,close,twohundredchg) VALUES (?,?,31,?,?)"  ; 
			...
			PreparedStatement ps1 = con.prepareStatement(mysql1);
					...
					while (rs.next()) {
						...
						ps1.setDouble(4, rs.getDouble("onehundredfiftychg"));
						ps1.addBatch();
...
public static void main(String[] args) {
	...
	System.out.println("yr"+(month-1));		    
		*/  
	new OneHundredFiftyMovingAverage().run();
