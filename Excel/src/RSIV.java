...
public class RSIV extends MyDatabase{ 
...
String mycode;
	...
	public RSIV(int periodLength) throws Exception {
		super();
	...
	public RSIV(int periodLength,String code) throws Exception {
		super();
		this.periodLength = periodLength;
		avgList = new Stack<Averages>();
