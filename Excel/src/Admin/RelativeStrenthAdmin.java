 ...
 *
 */
public class RelativeStrenthAdmin extends MyDatabase{ 
	...
	public RelativeStrenthAdmin( String symbol,String compareCcode) throws Exception {
		super();
	...
	public RelativeStrenthAdmin() throws Exception {
		super();
		String mysql1 = "update data set rsichg=?,rsiasx=?,relativestrenght=? where code=? and date=?";
		ps1 = con.prepareStatement(mysql1);
    ...
    private void  getALLPrices()throws Exception{
		...
		rs = ps.executeQuery();
		while (rs.next()) {
			compareprices.add(new Price (rs.getDate("date"), 0,0,0,0,rs.getDouble("changePercent")*100      ));
		}
  ...
  //      	new  RelativeStrenthAdmin("tpm.ax","^AORD").run() ;
        	 ...
        	 try (DAOFactoryStock dt = new DAOFactoryStock()) {
               	...
               	//	  System.out.println(e.nextElement());  
              		...
              		new  RelativeStrenthAdmin( e.nextElement(),"^AORD").run() ;
